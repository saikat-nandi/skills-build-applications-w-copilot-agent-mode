...
async function seedDatabase() {
    try {
        ...
        await User.updateMany({ _id: { $in: [users[0]._id, users[1]._id, users[4]._id] } }, { teamId: teams[0]._id });
        await User.updateMany({ _id: { $in: [users[2]._id, users[3]._id] } }, { teamId: teams[1]._id });
        ...
        const workouts = await Workout.create([
            {
                ...
                description: 'Perfect for those starting their running journey. Build endurance gradually over 4 weeks.',
                type: 'running',
                difficulty: 'beginner',
            ...
            },
            {
                ...
                description: 'High-intensity interval training for competitive swimmers.',
                type: 'swimming',
                difficulty: 'advanced',
            ...
            },
            {
                ...
                description: 'Complete strength training routine targeting all muscle groups.',
                type: 'gym',
                difficulty: 'intermediate',
                estimatedDuration: 60,
                caloriesBurned: 650,
